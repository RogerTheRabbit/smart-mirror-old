...
function WeatherXDays({numDays=1}) {
    ...
    const [forecast, setForecast] = useState(Array(numDays).fill({icon:'./loading.png', temp:"...", minTemp: "...", maxTemp: "...", dt: 0}));
    ...
    function getWeather() {
        ...
        .then(function(data) {
            ...
            if(data.cod === 429) {
                ...
                setForecast(Array(numDays).fill({icon:'./unavailable.png', temp:"...", minTemp: "...", maxTemp: "...", day: "today", dt: 0}))
                return;
            }
        ...
        .catch(function(error) {
            ...
            setForecast(Array(numDays).fill({icon:'./unavailable.png', temp:"...", minTemp: "...", maxTemp: "...", dt: 0}))
        })
    }
